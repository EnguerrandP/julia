...
@test_huge 3 'a' Struct_huge3a((1.0 + 2.0im, 3.0 + 4.0im, 5.0 + 6.0im), 7.0, 8.0)
@test_huge 3 'b' Struct_huge3b((1.0 + 2.0im, 3.0 + 4.0im, 5.0 + 6.0im, 7.0 + 8.0im, 9.0 + 10.0im, 11.0 + 12.0im, 13.0 + 14.0im), 7.0, 8.0)
@test_huge 3 'c' Struct_huge3c((1.0 + 2.0im, 3.0 + 4.0im, 5.0 + 6.0im, 7.0 + 8.0im, 9.0 + 10.0im, 11.0 + 12.0im, 13.0 + 14.0im), 7.0, 8.0, 9.0)
@test_huge 4 'a' Struct_huge4a(1.0 + 2.0im, 3.0 + 4.0im, 5.0f0 + 6.0f0im, 7.0 + 8.0im, 9.0)
@test_huge 4 'b' Struct_huge4b(1.0 + 2.0im, 3.0 + 4.0im, 5.0f0 + 6.0f0im, 7.0 + 8.0im, 9.0 + 10.0im)
@test_huge 5 'a' (Cint(1) + Cint(2)im, Cint(3) + Cint(4)im, Cint(5) + Cint(6)im, Cint(7) + Cint(8)im,
    Cint(9) + Cint(10)im, Cint(11) + Cint(12)im, Cint(13) + Cint(14)im, Cint(15) + Cint(16)im)
@test_huge 5 'b' (Cint(1) + Cint(2)im, Cint(3) + Cint(4)im, Cint(5) + Cint(6)im, Cint(7) + Cint(8)im,
    Cint(9) + Cint(10)im, Cint(11) + Cint(12)im, Cint(13) + Cint(14)im, Cint(15) + Cint(16)im, Cint(17) + Cint(17)im)
